...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PWR_7V5_EN_Pin BQ_DFETOFF_Pin PWR_19V_EN_Pin */
  GPIO_InitStruct.Pin = PWR_7V5_EN_Pin|BQ_DFETOFF_Pin|PWR_19V_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PER_12V_EN_Pin BQ_CFETOFF_Pin */
  GPIO_InitStruct.Pin = PER_12V_EN_Pin|BQ_CFETOFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : WS2812_DATA_Pin */
  GPIO_InitStruct.Pin = WS2812_DATA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(WS2812_DATA_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SYS_FAN_SPD_Pin */
  GPIO_InitStruct.Pin = SYS_FAN_SPD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SYS_FAN_SPD_GPIO_Port, &GPIO_InitStruct);
